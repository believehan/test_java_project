...
public class DBconnector {
	...
	public static Connection getInstance(String dbms, String hostName_ip, int portNum, String serviceName_dbName,
			String userName, String psw) throws ClassNotFoundException, SQLException, NullPointerException {
